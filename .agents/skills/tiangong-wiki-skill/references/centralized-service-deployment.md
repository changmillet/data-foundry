...
```bash
sudo -u tiangong-wiki mkdir -p /home/wiki/.ssh
sudo -u tiangong-wiki ssh-keygen -t ed25519 -f /home/wiki/.ssh/id_ed25519 -N ""
sudo -u tiangong-wiki ssh-keyscan github.com >> /home/wiki/.ssh/known_hosts
