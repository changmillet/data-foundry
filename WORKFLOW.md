...
- Do not generate or apply extra multilingual text before database import. The import lane keeps only the source/original language; additional language completion is outside the import gate.
