...
Import lanes must not require `bilingual-gate` before database import. Use contract context, schema, QA, reference, dry-run, and verification gates for source-language rows, then route multilingual completion separately after import.
