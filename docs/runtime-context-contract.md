...
lastReviewedNote: "Reviewed for Foundry #180: exact CLI 0.1.17 runtime identity and spec 0.2.1 source manifest advance without changing process-local trust selection or task authorization."
related:
