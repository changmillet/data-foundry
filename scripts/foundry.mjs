  ...
  if (options.help) {
    return {
      ...
      usage: [
        ...
        "npm run dataset:patch:apply -- --input ./rows/processes.jsonl --patch ./curation/patches.json --out ./rows/processes.patched.jsonl --out-dir ./patch-apply --authoring-package-dir ./curation-gate/ai-authoring-packages --require-action-item-closure",
      ],
      foundry_wrapper: {
        exit_code: 0,
        owner: "tiangong-lca-cli",
  ...
  if (options.help) {
    return {
      ...
      usage: [
        ...
        "npm run dataset:identity-preflight:run -- --index ./identity-preflight-requests/identity-preflight-requests.jsonl --only-pending --timeout-ms 60000",
      ],
      remote_write_mode: "read-only",
    };
  }
  ...
  if (options.help) {
    return {
      ...
      usage: [
        ...
        "npm run dataset:identity-preflight-index:merge -- --base-index ./identity-preflight-requests.jsonl --update-index ./fresh/identity-preflight-requests.jsonl",
      ],
      remote_write_mode: "read-only",
    };
  }
